...
/**
 * Show an image select dialogue and send it to the api.
 *
 * This will allow the user to select an image from their library
 * and will upload it as a media item to the api.
 */
