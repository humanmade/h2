...
import createFetchRelatedObjectActionCreator
  from './createFetchRelatedObjectActionCreator';
...
class WordPress_REST_API_Redux {
  ...
  addObjectConfig(objectName, options, api) {
    ...
    if (options.relations) {
      Object.entries(options.relations).forEach(([
        relatedObjectName,
...
export {
  ...
  createFetchRelatedObjectsActionCreator,
  createFetchRelatedObjectActionCreator,
};
